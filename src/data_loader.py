...
if __name__ == "__main__":
    # project_root points at the repository root, so use "data" here.
    ...
    # print("Example document:---------------------------------------\n", docs[3000] if docs else None)
   # print("docs[3000].metadata:-------------------------------------\n", docs[3000].metadata if docs else None)
   #print("docs[3000].page_content:---------------------------------\n", docs[3000].page_content if docs else None)